...
function Certificates(){
    ...
    const graduation = new Certificate("\images\\certificates\\Diploma.jpg", "\images\\certificates\\Pos-graduacao.png", "Faculdade de engenharia da computação que comecei em 2014, foi meu primeiro contato com programação. Desde cedo gostei de participar das maratonas de programação e adorava os desafios que eram passados.");
